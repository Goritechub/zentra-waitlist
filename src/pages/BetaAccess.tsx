...
function SlideShowcase() {
  ...
  const contentStyle: React.CSSProperties =
    phase === "in"
      ? { animation: "zg-slide-in 0.45s cubic-bezier(0.22,1,0.36,1) forwards" }
      : phase === "out"
      ? { animation: "zg-slide-out 0.45s cubic-bezier(0.55,0,0.45,1) forwards" }
      : {};

  return (
    <div className="relative w-full flex flex-col items-center justify-center rounded-2xl border border-border min-h-[380px]"
    ...
    >
      ...
      {/* Animated content */}
      <div className="relative px-14 py-16" style={contentStyle}>
          ...
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-5">
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-bold tracking-widest uppercase border"
